    ...
    <Navigation />
     ...
     <div className='h-full md:w-[400px] md:mt-20 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
        ...
        <p className='text-sm mb-5'>At least add 3 images of your property for good visibility and high response.</p>
         <Link href={'pricing-&others'}>
         <button className='w-full bg-blue-600 rounded-md px-8 py-3 font-bold text-white my-3  hover:bg-white hover:border-2 hover:border-blue-600 hover:text-blue-600'>Continue</button>  
         </Link>
     </div>
 </div>
 </section>
