  ...
  return (
    ...
    <NavigationCOwner />
     ...
     <div className='h-full md:w-[400px] md:mt-20 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
         ...
         <button className='w-full bg-blue-600 rounded-md px-8 py-3 font-bold text-white  hover:bg-white hover:text-blue-600 hover:border hover:border-blue-600'>Continue</button>
