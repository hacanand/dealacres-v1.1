...
const SingleAgentPage = () => {
  ...
  return (
    <div>
      ...
      <div className='max-w-screen-md  px-4 xs:px-8 md:px-16 flex gap-8 md:mx-auto overflow-hidden  py-4 my-4 rounded-[2rem] border-[3px] border-black shadow-[0px_0px_rgba(0,0,0.2),_0px_3px]'>
