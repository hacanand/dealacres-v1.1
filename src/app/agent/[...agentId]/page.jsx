...
const SingleAgentPage = () => {
  ...
  return (
    <div>
      ...
      {/* services */}
      <div className='max-w-screen-lg mx-auto px-6 mb-3'>
      ...
      <div className='max-w-screen-md  px-6 flex flex-col sm:flex-row gap-8 mx-2 lg:mx-auto   overflow-hidden  py-4 my-4 rounded-[2rem] border-[3px] border-black'>
      ...
      <div className='max-w-screen-md mx-auto px-6  py-4 my-4 flex  flex-col md:flex-row gap-4 items-center '>
