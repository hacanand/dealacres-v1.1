...
const InvestWithDealAcres = () => {
  return (
    <div className='max-w-screen-xl mx-auto max-[440px]:px-2 px-4'>
      <InvestBanner />
<div className='max-w-screen-lg mx-auto px-4'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[repeat(4,230px)] md:grid-cols-4  overflow-x-auto    gap-8 md:gap-4 items-stretch md:items-start md:justify-start py-8'>
