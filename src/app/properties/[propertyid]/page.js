  ...
  return (
    <>
      ...
      <div className={styles.bottomContainer}>
        ...
        <p>The material and information contained herein is for general informational purposes only, and does not constitute an endorsement/warranty/ representation/offer from Dealacres.com.<br />
