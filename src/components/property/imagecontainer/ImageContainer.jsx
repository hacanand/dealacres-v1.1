    ...
    <div className={styles.container}>
      ...
      <div className={styles.sideImgContainer}>
        <div className={styles.sideImage}>
          <Image
            src={props?.imageData?.sidePic?.type[0]}
            alt="Side Image 1"
            layout="fill"
            style={{ objectFit: "cover" }}
          />
        ...
        <div className={styles.sideImage}>
          <Image
            src={props?.imageData?.sidePic?.type[1]}
            alt="Side Image 2"
            layout="fill"
            style={{ objectFit: "cover" }}
          />
      ...
      {props.floorPlan && (
        <button className={`${styles.floorPlanButton} hidden`}>
          <BsMap style={{ display: "inline" }} /> Floor Plan
        </button>
      )}
      <button
        className={`${styles.viewImagesButton} ${
          styles[props.imageButtonPosition]
        } hidden md:block`}
        onClick={() => {
          setCarasouel(true);
        }}
      >
        <IoCameraOutline style={{ display: "inline" }} /> View Images
      </button>
