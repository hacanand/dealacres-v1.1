        ...
        <div className='w-full text-sm sm:text-base' >
            ...
            <div className='flex flex-row  w-full py-2 gap-2'>
                <div className='w-1/2 flex flex-col'>
                    <label className='font-bold text-sm sm:text-base' htmlFor="title">
                        Title
                    </label>
                    <input type="text"
                        id='title'
                        className='border border-black outline-none py-1 text-sm sm:text-base px-4 rounded shadow' />
                </div>
                <div className='w-1/2 flex flex-col  '>
                    <label className='font-bold text-sm sm:text-base' htmlFor="title">
                        Rating
            ...
            <div className='flex flex-col w-full py-2'>
                ...
                <textarea className='border border-black outline-none py-1 text-sm sm:text-base px-4 rounded shadow' />
            </div>

            <button className='w-full py-1 sm:py-2 text-white bg-blue-600 rounded shadow text-sm sm:text-base md:text-xl font-bold'>
                Submit
            </button>
