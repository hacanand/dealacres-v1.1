        ...
        <div className="relative z-50 bg-white p-8 rounded-lg shadow-lg w-[40%]">
          ...
          <div className="flex flex-col border border-blue-700  rounded-md  ">
            ...
            <div className="flex flex-row gap-2 items-center">
              <select
                className="text-base px-3 py-4 rounded-md border-r border-blue-700"
                value={selectedResedential}
                onChange={handleResedentialChange}
              >
                <option className="text-base">All Residential</option>
                <option className="text-md" value="Gurugaon">
                  Gurugaon
                </option>
                <option className="text-md" value="Delhi">
                  Delhi
                </option>
                <option className="text-md" value="Mumbai">
                  Mumbai
                </option>
              </select>
              <IoSearch color="#344955" className="h-6 w-6" />
              <input placeholder="city name" className="py-3 px-1" />
              <Link href={"/all-property"} scroll={false}>
                <button className=" bg-blue-700 h-[50%] mx-auto mr-2 rounded-full text-white font-bold py-1 px-4">
                  Search
                </button>
              </Link>
            </div>
